                  ...
                  <div class="sample-card">
                    ...
                    <div class="sample-info">
                      ...
                      <div class="label-tags">
                        <a-tag
                          v-for="(cls, idx) in aggregatedLabels(item)"
                          :key="idx"
                          color="blue"
                        >
                          {{ classNameByIndex(cls.classIndex) }}<span v-if="cls.count > 1">*{{ cls.count }}</span>
                        </a-tag>
                      </div>
                    </div>
                  </div>
    ...
    >
      <a-form :model="uploadForm" layout="vertical">
        ...
        <a-form-item label="描述">
          <a-textarea v-model:value="uploadForm.description" :rows="3" placeholder="请输入数据集描述" />
        </a-form-item>
...
import { yoloApi, type YoloDatasetSummary, type YoloDatasetDetail, type YoloDatasetSampleItem } from '@/api/yolo'
