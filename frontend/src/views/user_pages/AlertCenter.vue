<template>
  <div class="alert-center-page">
            ...
            <div class="card-content">
              ...
              <div class="detection-stats">
                ...
                <div class="stat-item">
                  ...
                  <span class="stat-value">{{ (alert.detection_info.avg_confidence * 100).toFixed(1) }}%</span>
                </div>
              </div>
            </div>
    ...
    <!-- 时间线布局 -->
    <div v-else-if="layoutMode === 'timeline'" class="alerts-timeline-layout" :key="`timeline-${layoutKey}`">
      <a-spin :spinning="loading">
...
const highRiskAlerts = computed(() => alerts.value.filter(alert => alert.alert_level === 'high').length)
const mediumRiskAlerts = computed(() => alerts.value.filter(alert => alert.alert_level === 'medium').length)
