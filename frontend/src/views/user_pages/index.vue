          ...
          <div v-else class="dashboard-content">
            ...
            >
              ...
              <div v-else class="stats-vertical-list">
                ...
                <!-- <div class="charts-section" :class="`layout-${currentDashboardLayout}`">
                  <h2 class="section-title">检测统计</h2>
                  <a-row :gutter="[16, 16]">
                    <a-col :xs="24" :lg="12">
                      <a-card title="检测类型分布" class="chart-card" :loading="yoloStatsLoading">
                        <div ref="pieChartEl" class="chart-container"></div>
                      </a-card>
                    </a-col>
                    <a-col :xs="24" :lg="12">
                      <a-card title="近一周检测次数" class="chart-card" :loading="yoloStatsLoading">
                ...
                <div class="color-item">
                  ...
                  <div class="color-picker-wrapper">
                    <input 
                      ...
                      @input="(e) => { themeConfig.headerBg = (e.target as HTMLInputElement).value; currentPreset = 'custom'; themeStore.updateTheme(themeConfig); }"
                      class="color-input"
                    />
                    <a-input 
                      v-model:value="themeConfig.headerBg"
                      @change="() => { currentPreset = 'custom'; themeStore.updateTheme(themeConfig); }"
                ...
                <div class="color-item">
                  ...
                  <div class="color-picker-wrapper">
                    <input 
                      ...
                      @input="(e) => { themeConfig.headerText = (e.target as HTMLInputElement).value; currentPreset = 'custom'; themeStore.updateTheme(themeConfig); }"
                      class="color-input"
                    />
                    <a-input 
                ...
                <div class="color-item">
                  ...
                  <div class="color-picker-wrapper">
                    <input 
                      ...
                      @input="(e) => { themeConfig.headerBorder = (e.target as HTMLInputElement).value; currentPreset = 'custom'; themeStore.updateTheme(themeConfig); }"
                      class="color-input"
                    />
                    <a-input 
                ...
                <div class="color-item">
                  ...
                  <div class="color-picker-wrapper">
                    <input 
                      ...
                      @input="(e) => { themeConfig.pageBg = (e.target as HTMLInputElement).value; currentPreset = 'custom'; themeStore.updateTheme(themeConfig); }"
                      class="color-input"
                    />
                    <a-input 
                ...
                <div class="color-item">
                  ...
                  <div class="color-picker-wrapper">
                    <input 
                      ...
                      @input="(e) => { themeConfig.contentBg = (e.target as HTMLInputElement).value; currentPreset = 'custom'; themeStore.updateTheme(themeConfig); }"
                      class="color-input"
                    />
                    <a-input 
                ...
                <div class="color-item">
                  ...
                  <div class="color-picker-wrapper">
                    <input 
                      ...
                      @input="(e) => { themeConfig.cardBg = (e.target as HTMLInputElement).value; currentPreset = 'custom'; themeStore.updateTheme(themeConfig); }"
                      class="color-input"
                    />
                    <a-input 
                ...
                <div class="color-item">
                  ...
                  <div class="color-picker-wrapper">
                    <input 
                      ...
                      @input="(e) => { themeConfig.cardBorder = (e.target as HTMLInputElement).value; currentPreset = 'custom'; themeStore.updateTheme(themeConfig); }"
                      class="color-input"
                    />
                    <a-input 
                ...
                <div class="color-item">
                  ...
                  <div class="color-picker-wrapper">
                    <input 
                      ...
                      @input="(e) => { themeConfig.primaryColor = (e.target as HTMLInputElement).value; currentPreset = 'custom'; themeStore.updateTheme(themeConfig); }"
                      class="color-input"
                    />
                    <a-input 
                ...
                <div class="color-item">
                  ...
                  <div class="color-picker-wrapper">
                    <input 
                      ...
                      @input="(e) => { themeConfig.textPrimary = (e.target as HTMLInputElement).value; currentPreset = 'custom'; themeStore.updateTheme(themeConfig); }"
                      class="color-input"
                    />
                    <a-input 
                ...
                <div class="color-item">
                  ...
                  <div class="color-picker-wrapper">
                    <input 
                      ...
                      @input="(e) => { themeConfig.textSecondary = (e.target as HTMLInputElement).value; currentPreset = 'custom'; themeStore.updateTheme(themeConfig); }"
                      class="color-input"
                    />
                    <a-input 
...
import { ref, computed, onMounted, defineAsyncComponent, watch, h, onUnmounted, onActivated, nextTick } from 'vue'
...
import { userMenuItems, getMenuPath, getMenuBreadcrumb, userComponentMap, getFilteredUserMenuItems, type MenuItem } from '@/router/user_menu_ai'
import { userApi, type User } from '@/api/user'
import { logoutUser } from '@/api/auth'
import { detectionHistoryApi } from '@/api/yolo'
import { systemMonitorApi } from '@/api/system_monitor'
...
const yoloStatsLoading = ref(false)
const yoloStats = ref<{
...
const weekDetectionCount = computed(() => {
  return (yoloStats.value?.recent_activity || []).reduce((sum, item) => sum + (item.count || 0), 0)
})
...
const dashboardStats = computed<DashboardStat[]>(() => {
  const totalDetections = yoloStats.value?.total_detections ?? 0
  const totalImages = yoloStats.value?.total_images ?? 0
  const memoryText =
    memoryUsagePercent.value === null || Number.isNaN(memoryUsagePercent.value)
      ? '--'
      : `${Math.round(memoryUsagePercent.value)}%`
  return [
    { icon: ScanOutlined, color: 'purple', value: String(totalDetections), label: '累计检测', trend: undefined, badge: undefined },
    { icon: HistoryOutlined, color: 'blue', value: String(weekDetectionCount.value), label: '近7天检测', trend: undefined, badge: undefined },
    { icon: FileImageOutlined, color: 'green', value: String(totalImages), label: '图片检测', trend: undefined, badge: undefined },
    { icon: DatabaseOutlined, color: 'orange', value: memoryText, label: '内存使用率', trend: undefined, badge: undefined }
  ]
})
...
const initOrUpdateCharts = async () => {
  ...
  if (!pieChartEl.value || !barChartEl.value) return
  if (!yoloStats.value) return

  const classEntries = Object.entries(yoloStats.value.class_counts || {})
    .map(([name, value]) => ({ name, value }))
    .sort((a, b) => b.value - a.value)

  const pieData = classEntries.slice(0, 10)
  const otherSum = classEntries.slice(10).reduce((sum, item) => sum + item.value, 0)
  ...
  const xAxisData = (yoloStats.value.recent_activity || []).map(i => i.date.slice(5))
  const seriesData = (yoloStats.value.recent_activity || []).map(i => i.count || 0)
  ...
  barChart.setOption(
    {
      ...
      series: [{ type: 'bar', data: seriesData, barMaxWidth: 42 }]
    },
    true
  )
}

const fetchYoloStats = async () => {
  const userId = userStore.userInfo?.user_id
  if (!userId) return

  yoloStatsLoading.value = true
  try {
    const res = await detectionHistoryApi.getDetectionStats(userId)
    if (res?.success && res.data) {
      yoloStats.value = res.data
    } else {
...
const fetchMemoryUsage = async () => {
  ...
  try {
    const res = await systemMonitorApi.getMemory()
    if (res?.success && res.data && typeof res.data.percent === 'number') {
      memoryUsagePercent.value = res.data.percent
    } else {
      memoryUsagePercent.value = null
    }
  } catch {
    memoryUsagePercent.value = null
  } finally {
...
const refreshYoloDashboard = async () => {
  await fetchMemoryUsage()
  await fetchYoloStats()
...
const dashboardLayouts = [
  {
    ...
    statsLayout: { xs: 24, sm: 12, md: 12, lg: 6, xl: 6 },
  ...
  },
  {
    ...
    statsLayout: { xs: 24, sm: 24, md: 24, lg: 24, xl: 24 },
