...
urlpatterns = [
    ...
    # Hertz Auth routes
    path('api/auth/token/refresh/', views.token_refresh_override, name='token_refresh_override'),
    ...
    # Hertz Log routes
    path('api/log/list/', views.operation_log_list_override, name='operation_log_list_override'),
    ...
    # Hertz LPR routes
    path('api/lpr/', include('hertz_studio_django_lpr.urls')),

    # Hertz YOLO routes
    path('api/yolo/detect/', views.yolo_detection_with_lpr, name='yolo_detection_with_lpr'),
    path('api/yolo/detections/', views.yolo_detections_with_plate, name='yolo_detections_with_plate'),
    path('api/yolo/detections/<int:pk>/', views.yolo_detection_detail_with_plate, name='yolo_detection_detail_with_plate'),
    path('api/yolo/detections/stats/', views.yolo_detection_stats, name='yolo_detection_stats'),
    path('api/yolo/detections/export/', views.yolo_detection_export, name='yolo_detection_export'),
